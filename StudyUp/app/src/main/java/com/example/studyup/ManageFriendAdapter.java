...
public class ManageFriendAdapter extends RecyclerView.Adapter<ManageFriendAdapter.GroupViewHolder> {
    ...
    public ManageFriendAdapter(FragmentActivity mCtx, List<Friend> friendList) {
        this.mCtx = mCtx;

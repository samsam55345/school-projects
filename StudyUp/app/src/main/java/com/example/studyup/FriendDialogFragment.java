...
import com.example.studyup.ui.createGroup.CreateGroupFragment;
       ...
       Button submit = (Button) v.findViewById(R.id.button_select_friends);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getTargetFragment().onActivityResult(getTargetRequestCode(),12,i);
        ...
        //setadapter
         adapter = new SelectFriendAdapter((FragmentActivity) getContext(), friendList);

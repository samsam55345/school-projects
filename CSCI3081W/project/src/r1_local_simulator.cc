 ...
 */
#include "src/r1_local_simulator.h"
...
bool r1LocalSimulator::Start() {
 ...
 RtestPassengerGenerator * CC_WB_generator = new RtestPassengerGenerator (CC_WB_probs, CC_WB_stops_list);
  ...
  Route * CC_WB = new Route("Campus Connector - Westbound", CC_WB_stops, CC_WB_distances, 6, CC_WB_generator);

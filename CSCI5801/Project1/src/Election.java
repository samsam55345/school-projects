...
public class Election {
	...
	protected PrintWriter auditWriter;	// object to write the report
	...
	Election(String voteType, int numSeats, File[] files, boolean shuffle) throws FileNotFoundException {
		...
		// clear anything from the files that may be left o
		...
		for (File file: files) {
			...
			if (file.isFile()) {
				try {
					...
					// Read each ballot record from the file
	 ...
	 */
	private void setTesting(String testFile) {
